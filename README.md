...
> This project uses Gradle. If your usual build tool is Maven, check out the analogous project: [An example of effective mutation testing in Spring Boot 3 projects with Maven](https://github.com/ismail2ov/mutation-testing-with-maven).
